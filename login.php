...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($role)) {
        ...
        $sql = "SELECT * FROM users WHERE user_username = '$usernameInput' AND user_password = '$password' AND user_role = '$role'";
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            // Keep saving both the ID and Username to the session so the dashboard works!
