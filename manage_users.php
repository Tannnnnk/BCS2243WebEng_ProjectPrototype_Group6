...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; }
        ...
        .system-logo { width: 36px; height: 36px; background-color: #10b981; color: white; border-radius: 8px; display: flex; justify-content: center; align-items: center; }
        .user-profile-section { display: flex; align-items: center; gap: 20px; }
        .profile-group { display: flex; align-items: center; gap: 12px; }
        .top-bar-photo { width: 40px; height: 40px; background-color: #334155; border-radius: 50%; border: 2px solid #10b981; display: flex; justify-content: center; align-items: center; overflow: hidden; font-size: 14px; font-weight: bold; color: white; }
