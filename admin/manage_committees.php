            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?php 
                            if (!empty($club['club_photo'])): 
                                // Clean up the path: ensure there is a slash between 'uploads' and the filename
                                $img_filename = ltrim($club['club_photo'], '/');
                                $img_path = "../uploads/" . $img_filename;
                            ?>
                                <img src="../<?php echo $img_path; ?>" class="club-logo-img" onerror="this.src='https://via.placeholder.com/50?text=No+Img'">
                            <?php else: ?>
