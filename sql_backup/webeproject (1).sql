...
CREATE TABLE `administrator` (
  ...
  `admin_department` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `admin_position` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `attendance` (
  `attendanceID` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `attendance_date` date DEFAULT NULL,
  `attendance_time` time DEFAULT NULL,
  `attendance_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `eventID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `club` (
  `clubID` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `club_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `club_desc` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `userID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `club_operational_status` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `club_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `committee` (
  `committeeID` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `eventID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `memberID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `eventregistration` (
  ...
  `registration_status` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `events` (
  `eventID` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `event_title` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `event_desc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `event_date` date DEFAULT NULL,
  `event_time` time DEFAULT NULL,
  `event_venue` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `event_max_participants` int DEFAULT NULL,
  `attendance_qr` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `membership` (
  ...
  `userID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `clubID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `membershiprole` (
  ...
  `m_role_desc` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `points` (
  `pointID` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `stu_enforce` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `point_value` int DEFAULT NULL,
  `attendanceID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `userID` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `students` (
  ...
  `stu_address` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `stu_role` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `stu_contact_no` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `stu_profile_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
