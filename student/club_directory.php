...
// 2. Updated SQL with dynamic sorting
$sort_sql = match($sort) {
...
<body>
    ...
    <div class="content-area">
        ...
        <div class="club-grid-container">
         ...
         <form method="GET" style="margin-bottom: 30px; display: flex; gap: 15px; align-items: center; background: white; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0;">
    ...
    <button type="submit" style="padding: 10px 25px; background: #10b981; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold;">Apply Filters</button>
    
    <a href="?" style="padding: 10px 20px; background: #e2e8f0; color: #4a5568; border-radius: 8px; text-decoration: none; font-size: 14px;">Reset</a>
</form>
