...
if ($check_join && mysqli_num_rows($check_join) > 0) {
    $joined = true;
}
    ...
    <div class="content-area">
        ...
        <div class="two-col">
            ...
            <div class="section-card">
                ...
                <?php endif; ?>
                <?php if ($joined): ?>
    <div style="display: inline-flex; align-items: center; gap: 8px; background: #e0f2fe; color: #0369a1; padding: 10px 20px; border-radius: 6px; font-weight: bold; font-size: 14px;">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11"></polyline></svg>
        Registered Member
    </div>
<?php else: ?>
    <form method="POST" action="join_club.php"
        ...
        <button type="submit"
            style="background: #10b981; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-weight: bold; font-size: 14px; display: inline-flex; align-items: center; gap: 8px; transition: background 0.2s;">
            Join Club
        </button>
    </form>
<?php endif; ?>
