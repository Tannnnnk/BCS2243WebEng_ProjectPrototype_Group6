...
<body>
    ...
    <div style="display: flex; align-items: flex-start; gap: 20px;">
        ...
        <?php else: ?>
            <div style="width: 100px; height: 100px; background: #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 11px; flex-shrink: 0;">No Logo</div>
        <?php endif; ?>
